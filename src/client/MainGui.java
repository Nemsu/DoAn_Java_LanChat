...
public class MainGui {
	...
	private void initialize() {
		...
		btnChat.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if (name.equals(nameUser)) {
					Tags.show(frameMainGui, "Cant start chat room alone", false);
					return;
				}
		...
		lblLogo = new JLabel("JAVA LAN CHAT & FILE TRANSFER");
		lblLogo.setForeground(new Color(0, 0, 205));
		lblLogo.setIcon(new javax.swing.ImageIcon(MainGui.class.getResource("/image/lttc.png")));
